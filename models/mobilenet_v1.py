...
class MobileNet(nn.Module):
    def __init__(self, n_class, profile='1.0'):
        ...
        # 0.75
            ...
            in_planes = 24
            cfg = [48, (96, 2), 96, (192, 2), 192, (384, 2), 384, 384, 384, 384, 384, (768, 2), 768]
        # 0.5 AMC
        elif profile == '0.5flops':
            in_planes = 24
            cfg = [48, (96, 2), 80, (192, 2), 200, (328, 2), 352, 368, 360, 328, 400, (736, 2), 752]
        # 0.5 time
        elif profile == '0.5time':
            in_planes = 16
            cfg = [48, (88, 2), 80, (192, 2), 168, (336, 2), 360, 360, 352, 352, 368, (768, 2), 680]
        else:
